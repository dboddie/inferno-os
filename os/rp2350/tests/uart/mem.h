// ROM is the location of XIP memory on the RP2350.
#define ROM_START       0x10000000
#define VEC_SIZE        0x110
...
/* Memory map: SRAM at 0x20000000-0x20082000 (520KB)
               data | alloc | mach | stack */

#define SRAM_BASE       0x20000000
#define SRAM_TOP        0x20082000
#define STACK_TOP       (SRAM_TOP - 4)
#define STACKTOP        STACK_TOP
