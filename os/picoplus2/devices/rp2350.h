...
#define GPIO7_IO_ADDR (IO_BANK0_BASE + 0x38)
...
#define GPIO0_PAD_ADDR (PADS_BANK0_BASE + 0x04)
...
#define GPIO7_PAD_ADDR (PADS_BANK0_BASE + 0x20)
...
#define USBCTRL_REGS_SET_BASE 0x50112000
...
enum {
    ...
    USB_SIE_CTRL_PULLUP_EN      = 0x00010000,
    USB_SIE_STATUS_BUS_RESET    = 0x00080000,
    USB_SIE_STATUS_SETUP_REC    = 0x00020000,
    USB_INT_SETUP_REQ   = 0x00010000,
    USB_INT_BUS_RESET   = 0x00001000,
    USB_INT_VBUS_DETECT = 0x00000800,
    USB_INT_BUFF_STATUS = 0x00000010,
...
#define USB_DPSRAM_EP1_BUF (USB_DPSRAM_BASE + 0x180)
#define USB_DPSRAM_EP2_BUF (USB_DPSRAM_BASE + 0x200)
#define USB_DPSRAM_EP3_BUF (USB_DPSRAM_BASE + 0x280)
#define USB_EP0_IN_BUFCTL 32
#define USB_EP0_OUT_BUFCTL 33
#define USB_EP1_IN_EPCTL 2
#define USB_EP2_OUT_EPCTL 5
#define USB_EP3_IN_EPCTL 6
#define USB_EP1_IN_BUFCTL 34
#define USB_EP2_OUT_BUFCTL 37
#define USB_EP3_IN_BUFCTL 38

enum {
    USB_BCR_FULL  = 0x8000,
    USB_BCR_LAST  = 0x4000,
    USB_BCR_SEL   = 0x1000,
    USB_BCR_STALL = 0x0800,
    USB_BCR_AVAIL = 0x0400,
    USB_BCR_DATA0 = 0x0000,
    USB_BCR_DATA1 = 0x2000,
    USB_BCR_LEN_MASK = 0x03ff,
};
